...
/**
 * Slide in show element horizontally with fading
 * 
 * @param el - The target element
 * @param gsap - The GSAP object, make sure it's attached to ScrollTrigger
 * @param opt.transVal - The scaling value (optional, default "2rem")
...
export default function slideInX(
    el: gsap.TweenTarget,
    ...
    if (el !== null) {
        const animInit: gsap.TweenVars = {
            opacity: 0, translateX: opt && opt.transVal ? opt.transVal : '2rem',
            duration: 0
        }
